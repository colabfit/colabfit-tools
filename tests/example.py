...
ds1.description  = 'This data set was used to generate a multi-element linear SNAP potential for InP as published in Cusentino, M.A. et. al, J. Chem. Phys. (2020). Intended to produce an interatomic potential for indium phosphide capable of capturing high-energy defects that result from radiation damage cascades.'
...
ds2.description  = 'This dataset was originally designed to fit a GAP model for the Mo-Nb-Ta-V-W quinary system that was used to study segregation and defects in the body-centered-cubic refractory high-entropy alloy MoNbTaVW.'
...
# Build configuration sets by setting the cs_regexes dictionary
ds2.cs_regexes = {
    'default': 'A variety of Mo-Nb-Ta-V-W structures',
    'bcc_distorted': 'BCC configurations with random strains up to +/- 30% to help train the far-from-equilibrium elastic response',
    'binary_alloys': 'Binary BCC alloys sampling 10 different concentrations from A_0.05B_0.95 to A_0.95B_0.05 and 3 different lattice constants for every composition. Atoms are randomly ordered and shifted slightly from their lattice positions.',
    '^composition': 'Ternary, quaternary, and quinary BCC alloys. 3 linearly spaced compositions were sampled, each with 3 different lattice constants. Atoms are randomly ordered and shifted slightly from their lattice positions.',
    'di-sia': 'Configurations with two self-interstitial atoms',
    'di-vacancy': 'Configurations with two vacancies',
    'dimer': 'Dimers for fitting repulsive terms',
    'gamma_surface': 'Configurations representing the full gamma surface',
    'hea_ints': '1-5 interstitial atoms randomly inserted into HEA lattices and relaxed with a partially-trained tabGAP model',
    'hea_short_range': 'Randomly placed unrelaxed interstitial atom in HEAs to fit repulsion inside crystals, making sure that the closest interatomic distance is not too short for DFT to be unreliable (> 1.35 Ang)',
    'hea_small': 'Bulk equiatomic quinary HEAs. Atoms are randomly ordered and shifted slightly from their lattice positions. The lattice constant is randomised in the range 3-3.4 Angstrom',
    'hea_surface': 'Disordered HEA surfaces, including some of the damaged/molten surface configurations from an existing pure W dataset that were turned into HEAs',
    'hea_vacancies': '1-5 vacancies randomly inserted into HEA lattices, then relaxed with a partially-trained tabGAP model',
    'isolated_atom': 'Isolated atoms',
    '^liquid__': 'Liquid configurations',
    'liquid_composition': 'Liquid equiatomic binary, ternary, quaternary, and quinary alloys at different densities',
    'liquid_hea': 'Liquid HEA configurations',
    'mcmd': 'Equiatomic quinary alloys generated via active learning by running MCMD with a partially-trained tabGAP model.',
    'ordered_alloys': 'Ordered binary, ternary, and quaternary alloys (always as a BCC lattice, but with different crystal symmetries of the elemental sublattices)',
    ...
    '^sia': 'Configurations with a self-interstitial defect',
    'surf_liquid': 'Damaged and molten surfaces',
    'tri-vacancy': 'Configurations with three vacancies',
    '^vacancy': 'Configurations with one vacancy',
}
...
ds2.co_label_regexes = {
    ...
    'hea': 'hea',
    'hea_ints': 'interstitial',
    'isolated_atom': 'isolated_atom',
    'liquid': 'liquid',
    'mcmd': 'aimd',
    'phonon': 'aimd',
    'short_range': ['bcc', 'interstitial', 'repulsive', 'large_forces', 'warning'],
    'sia': 'interstitial',
    'surface': 'surface',
