potential_energy_pd = {
    ...
    "property-description": "Potential energy from a calculation of a static configuration. Energies may be specified to be per-atom or supercell. If a reference energy has been used, this must be specified as well.",
    "energy": {
        "type": "float",
        "has-unit": True,
        "extent": [],
    ...
    "per-atom": {
        ...
        "extent": [],
        "required": False,
        "description": "If True, \"energy\" is the total energy of the system divided by the number of atoms in the configuration."
    },
    "reference-energy": {
        "type": "float",
        "has-unit": True,
