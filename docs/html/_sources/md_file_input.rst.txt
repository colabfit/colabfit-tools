...
:meth:`~colabfit.tools.database.MongoDatabase.dataset_from_markdown` method.
Note that any Markdown file generated by the
:meth:`~colabfit.tools.database.MongoDatabase.dataset_to_markdown` function
should be readable by :meth:`from_markdown`, which can make it easy to publish
and distribute Datasets.
